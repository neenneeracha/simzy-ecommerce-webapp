 ...
 * RadioGroup.jsx
 *
 *    This file represents the multi-use radio input group component
 *    which allows user to select one option from option set
 *
 ********************************************************************
 */
...
const RadioGroup = (props) => {
  ...
  return (
    <FormControl>
      ...
      {error !== "" ? (
        <Typography style={{ fontSize: 14, color: "#F44336" }}>
          {error}
        </Typography>
      ) : undefined}
    </FormControl>
