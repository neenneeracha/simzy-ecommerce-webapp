 ...
 * ViewUsers.jsx
 *
 *   This file represents the SIMZY user details page and
 *   allow administrators to view, edit, delete and insert user
 *
 ********************************************************************
 */
        ...
        try {
          ...
          if (user.password !== undefined) {
            res = await axios.patch(
              "http://localhost:8080/api/v1/user/update-password-admin/" +
                selectedID,
              { password: user.password }
            );
          }
          res = await axios.patch(
            "http://localhost:8080/api/v1/user/update-info-admin/" + selectedID,
            { user: user }
          );
        ...
        {users.length > 0 ? (
          <>
            ...
            <PopUp
              title={
                formType === "view"
                  ? `View Details of User ID #${selectedID}`
                  : formType === "edit"
                  ? `Edit Details of User ID #${selectedID}`
                  : `Add New User`
              }
              openPopup={openPopup}
