...
const Register = () => {
    ...
    return ( <
        ...
        md = { 6 } >
        <
        Image src = { process.env.PUBLIC_URL + "img/register.png" }
        height = "80%"
        width = "80%"
        style = {
        ...
        Row >
        <
        Form.Group className = "d-block mx-auto w-50"
        controlId = "firstname"
        style = {
            { marginBottom: "30px" } } >
        <
        ...
        Form.Control.Feedback style = {
            { maxWidth: "400px", margin: "0px 2px 10px" } }
        type = "invalid" >
        { errors.firstname } <
        ...
        Description > (at least 6 characters long) < /Description> <
        /Form.Label> <
        ...
        /Form.Label> {
            ["radio"].map((type) => ( <
                Radio color = {!!errors.gender ? "#d9534f" : "black" }
                key = { `inline-${type}` }
                className = "mb-3" >
                <
                Form.Check inline label = "Woman"
                name = "gender"
                value = "W"
                type = { type }
                id = { `inline-${type}-1` }
